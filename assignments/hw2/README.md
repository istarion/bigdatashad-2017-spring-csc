...
Для выдачи посчитанных метрик используйте то же веб-приложение, что для hw1. Т.е. если для hw1 вы уже решение регистрировали, повтороно регистировать не нужно.
